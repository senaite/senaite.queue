...
configurations for running `senaite.queue`. We want to keep it as easy as 
...
bugs](https://github.com/senaite/senaite.queue/issues)? Do you have a
suggestion for improvement? Then by all means please [submit a new
issue](https://github.com/senaite/senaite.queue/issues/new), and do not
hesitate to comment on existing [open
issues](https://github.com/senaite/senaite.queue/issues).
...
The list of [open issues](https://github.com/senaite/senaite.queue/issues)
...
```
$ git remote -v
origin    https://github.com/YOUR_USERNAME/senaite.queue.git (fetch)
origin    https://github.com/YOUR_USERNAME/senaite.queue.git (push)
upstream  https://github.com/senaite/senaite.queue.git (fetch)
upstream  https://github.com/senaite/senaite.queue.git (push)
```
...
Alternatively, you can merge `senaite.queue`'s `master` into your branch:
...
request](https://github.com/senaite/senaite.queue/compare/). Head to your
 ...
 * Add a changelog entry in [CHANGES.rst](https://github.com/senaite/senaite.queue/CHANGES.rst)
